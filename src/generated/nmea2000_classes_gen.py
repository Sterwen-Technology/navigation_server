...
class Pgn129283Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_navigation_terminated', '_XTE_mode', '_XTE')
    ...
    def __str__(self):
        return f'PGN{self._pgn}({self._name}) [sequence_id={self._sequence_id}, navigation_terminated={self._navigation_terminated}, XTE_mode={self._XTE_mode}, XTE={self._XTE}]'
