...
class Pgn126996Class(NMEA2000DecodedMsg):
    ...
    def decode_payload(self, payload, start_byte=0):
        ...
        self._model_id = clean_string(payload[4 + start_byte: 36 + start_byte])
        self._software_version = clean_string(payload[36 + start_byte: 68 + start_byte])
        self._model_version = clean_string(payload[68 + start_byte: 100 + start_byte])
        self._model_serial_code = clean_string(payload[100 + start_byte: 132 + start_byte])
...
class Pgn127245Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        v1 = convert_to_int(self._angle, 0xffff, 0.005729577951308233)
        v2 = convert_to_int(self._position, 0xffff, 0.005729577951308233)
        v3 = 0xffff
...
class Pgn127250Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        v1 = convert_to_int(self._deviation, 0xffff, 0.005729577951308233)
        v2 = convert_to_int(self._variation, 0xffff, 0.005729577951308233)
...
class Pgn127258Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_system_id', '_source', '_age_of_service', '_variation')
    ...
    def encode_payload(self) -> bytearray:
        ...
        v0 |= 0xf << 4
        v1 = convert_to_int(self._variation, 0xffff, 0.005729577951308233)
        self._struct_str_0.pack_into(buffer, 0 + start_byte, self._system_id, v0, self._age_of_service, v1)
        return buffer
    ...
    def __str__(self):
        return f'PGN{self._pgn}({self._name}) [system_id={self._system_id}, source={self._source}, age_of_service={self._age_of_service}, variation={self._variation}]'
...
class Pgn127489Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        v3 = convert_to_int(self._alternator_voltage, 0xffff, 0.01)
        v4 = convert_to_int(self._fuel_rate, 0xffff, 0.1)
...
class Pgn127508Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        buffer = bytearray(buf_size)
        start_byte = 0
        v0 = convert_to_int(self._voltage, 0xffff, 0.01)
        v1 = convert_to_int(self._current, 0xffff, 0.1)
        v2 = convert_to_int(self._temperature, 0xffff, 0.01, -273.15)
...
class Pgn128259Class(NMEA2000DecodedMsg):
    ...
    @speed_over_ground_ref.setter
    def speed_over_ground_ref(self, value: float):
        self._speed_over_ground_ref = value
    ...
    def encode_payload(self) -> bytearray:
        ...
        buffer = bytearray(buf_size)
        start_byte = 0
        v0 = convert_to_int(self._speed_through_water, 0xffff, 0.01)
        v1 = convert_to_int(self._speed_over_ground_ref, 0xffff, 0.01)
        v2 = 0xffff
...
class Pgn128267Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        v1 = convert_to_int(self._offset, 0xffff, 0.001)
...
class Pgn129025Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        buffer = bytearray(buf_size)
        start_byte = 0
        v0 = convert_to_int(self._latitude, 0xffffffff, 1e-07)
        v1 = convert_to_int(self._longitude, 0xffffffff, 1e-07)
...
class Pgn129029Class(NMEA2000DecodedMsg):
    ...
    class Ref_StationsClass:
        ...
        def encode_payload(self, buffer, start_byte):
            ...
            v1 = convert_to_int(self._age_DGNSS_correction, 0xffff, 0.01)
            self._struct_str_0.pack_into(buffer, 0 + start_byte, v0, v1)
    ...
    def encode_payload(self) -> bytearray:
        ...
        v1 = convert_to_int(self._latitude, 0xffffffffffffffff, 1e-16)
        v2 = convert_to_int(self._longitude, 0xffffffffffffffff, 1e-16)
        v3 = convert_to_int(self._altitude, 0xffffffffffffffff, 1e-06)
        v4 = (self._method & 0xf) << 0
        v4 |= (self._GNSS_type & 0xf) << 4
        v5 = (self._integrity & 0x3) << 0
        v5 |= 0x3f << 2
        v6 = convert_to_int(self._HDOP, 0xffff, 0.01)
        v7 = convert_to_int(self._PDOP, 0xffff, 0.01)
        v8 = convert_to_int(self._geoidal_separation, 0xffffffff, 0.01)
...
class Pgn129038Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        v1 = convert_to_int(self._longitude, 0xffffffff, 1e-07)
        v2 = convert_to_int(self._latitude, 0xffffffff, 1e-07)
...
class Pgn129283Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_system_id', '_navigation_terminated', '_XTE_mode', '_XTE')
    ...
    def decode_payload(self, payload, start_byte=0):
        val = self._struct_str_0.unpack_from(payload, 0 + start_byte)
        self._system_id = val[0]
        self._navigation_terminated = (val[1] >> 1) & 0x1
        self._XTE_mode = (val[1] >> 4) & 0xF
    ...
    def encode_payload(self) -> bytearray:
        ...
        start_byte = 0
        v0 = 0x1 << 0
        v0 |= (self._navigation_terminated & 0x1) << 1
        v0 |= 0x3 << 2
        v0 |= (self._XTE_mode & 0xf) << 4
        v1 = convert_to_int(self._XTE, 0xffffffff, 0.01)
        self._struct_str_0.pack_into(buffer, 0 + start_byte, self._system_id, v0, v1)
        return buffer
    ...
    def __str__(self):
        return f'PGN{self._pgn}({self._name}) [system_id={self._system_id}, navigation_terminated={self._navigation_terminated}, XTE_mode={self._XTE_mode}, XTE={self._XTE}]'
...
class Pgn129284Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_system_id', '_distance_to_waypoint', '_bearing_reference', '_perpendicular_crossed', '_arrival_circle_entered', '_calculation_type', '_ETA_time', '_ETA_date', '_bearing_origin_to_destination', '_bearing_position_to_destination', '_origin_waypoint', '_destination_waypoint', '_destination_latitude', '_destination_longitude', '_WCV')
    ...
    def encode_payload(self) -> bytearray:
        ...
        v5 = convert_to_int(self._destination_latitude, 0xffffffff, 1e-07)
        v6 = convert_to_int(self._destination_longitude, 0xffffffff, 1e-07)
        v7 = convert_to_int(self._WCV, 0xffff, 0.01)
        self._struct_str_0.pack_into(buffer, 0 + start_byte, self._system_id, v0, v1, v2, self._ETA_date, v3, v4, self._origin_waypoint, self._destination_waypoint, v5, v6, v7)
        return buffer
...
class Pgn129285Class(NMEA2000DecodedMsg):
    ...
    class Wp_DefinitionsClass:
        ...
        def decode_payload(self, payload, start_byte=0):
            ...
            start_byte += dec_str_len
            val = self._struct_str_1.unpack_from(payload, 2 + start_byte)
        ...
        def encode_payload(self, buffer, start_byte):
            ...
            start_byte += inserted_len
            v0 = convert_to_int(self._waypoint_latitude, 0xffffffff, 1e-07)
            v1 = convert_to_int(self._waypoint_longitude, 0xffffffff, 1e-07)
    ...
    _struct_str_1_size = _struct_str_1.size
    __slots__ = ('_start_rps_nb', '_nb_items', '_database_id', '_route_id', '_supplementary_data', '_navigation_direction', '_route_name', '_WP_definitions')
    ...
    @property
    def start_rps_nb(self) -> int:
        return self._start_rps_nb
    ...
    @start_rps_nb.setter
    def start_rps_nb(self, value: int):
        self._start_rps_nb = value
    ...
    def decode_payload(self, payload, start_byte=0):
        val = self._struct_str_0.unpack_from(payload, 0 + start_byte)
        self._start_rps_nb = val[0]
        self._nb_items = check_valid(val[1], 65535, 0)
        self._database_id = val[2]
        self._route_id = val[3]
        self._supplementary_data = (val[4] >> 2) & 0x3
        self._navigation_direction = (val[4] >> 4) & 0xF
        start_byte += 9
        dec_str, dec_str_len = extract_var_str(payload, start_byte)
        self._route_name = dec_str
        start_byte += dec_str_len
        val = self._struct_str_1.unpack_from(payload, 9 + start_byte)
        start_byte += 1
        self._WP_definitions = []
        for i in range(0, self.nb_items):
            dec_obj, dec_obj_len = self.Wp_DefinitionsClass().decode_payload(payload, start_byte)
            self._WP_definitions.append(dec_obj)
            start_byte += dec_obj_len
    ...
    def encode_payload(self) -> bytearray:
        ...
        start_byte = 0
        v0 = 0x3 << 0
        v0 |= (self._supplementary_data & 0x3) << 2
        v0 |= (self._navigation_direction & 0xf) << 4
        self._struct_str_0.pack_into(buffer, start_byte, self._start_rps_nb, self._nb_items, self._database_id, self._route_id, v0)
        start_byte += 9
        ...
        for repeat_field in self._WP_definitions:
            encoded_len = repeat_field.encode_payload(buffer, start_byte)
            start_byte += encoded_len

        return buffer[:start_byte]

    def from_protobuf(self, message: Pgn129285ClassPb):
        self._start_rps_nb = message.start_rps_nb
    ...
    def as_protobuf(self) -> Pgn129285ClassPb:
        ...
        message.start_rps_nb = self._start_rps_nb
    ...
    def __str__(self):
        return f'PGN{self._pgn}({self._name}) [start_rps_nb={self._start_rps_nb}, nb_items={self._nb_items}, database_id={self._database_id}, route_id={self._route_id}, supplementary_data={self._supplementary_data}, navigation_direction={self._navigation_direction}, route_name={self._route_name}, WP_definitions={self._WP_definitions}]'
...
class Pgn129539Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0 = struct.Struct('<BBhhh')
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_system_id', '_desired_mode', '_actual_mode', '_HDOP', '_VDOP', '_TDOP')
    ...
    def encode_payload(self) -> bytearray:
        ...
        v1 = convert_to_int(self._HDOP, 0xffff, 0.01)
        v2 = convert_to_int(self._VDOP, 0xffff, 0.01)
        v3 = convert_to_int(self._TDOP, 0xffff, 0.01)
        self._struct_str_0.pack_into(buffer, 0 + start_byte, self._system_id, v0, v1, v2, v3)
        return buffer
    ...
    def __str__(self):
        return f'PGN{self._pgn}({self._name}) [system_id={self._system_id}, desired_mode={self._desired_mode}, actual_mode={self._actual_mode}, HDOP={self._HDOP}, VDOP={self._VDOP}, TDOP={self._TDOP}]'
...
class Pgn129540Class(NMEA2000DecodedMsg):
    ...
    class Satellites_DataClass:
        ...
        def encode_payload(self, buffer, start_byte):
            v0 = convert_to_int(self._elevation, 0xffff, 0.005729577951308233)
...
class Pgn129794Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        v5 = convert_to_int(self._draft, 0xffff, 0.01)
...
class Pgn130306Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        buffer = bytearray(buf_size)
        start_byte = 0
        v0 = convert_to_int(self._wind_speed, 0xffff, 0.01)
...
class Pgn130311Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        v2 = convert_to_int(self._humidity, 0xffff, 0.004)
...
class Pgn130316Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        buffer = bytearray(buf_size)
        start_byte = 0
        v0 = convert_to_int(self._actual_temperature, 0xffffff, 0.001, -273.15)
        v0 = v0 & 0xffff
        v1 = (v0 >> 16) & 0xff
...
class Pgn130578Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        buffer = bytearray(buf_size)
        start_byte = 0
        v0 = convert_to_int(self._longitudinal_speed_water, 0xffff, 0.001)
        v1 = convert_to_int(self._transverse_speed_water, 0xffff, 0.001)
        v2 = convert_to_int(self._longitudinal_speed_ground, 0xffff, 0.001)
        v3 = convert_to_int(self._transverse_speed_ground, 0xffff, 0.001)
        v4 = convert_to_int(self._stern_speed_water, 0xffff, 0.001)
        v5 = convert_to_int(self._stern_speed_ground, 0xffff, 0.001)
