...
class Pgn127245Class(NMEA2000DecodedMsg):
    ...
    def decode_payload(self, payload, start_byte=0):
        ...
        self._angle = check_convert_float(val[2], 0xffff, 0.005729577951308233)
        self._position = check_convert_float(val[3], 0xffff, 0.005729577951308233)
...
class Pgn127250Class(NMEA2000DecodedMsg):
    ...
    def decode_payload(self, payload, start_byte=0):
        ...
        self._deviation = check_convert_float(val[2], 0xffff, 0.005729577951308233)
        self._variation = check_convert_float(val[3], 0xffff, 0.005729577951308233)
...
class Pgn128259Class(NMEA2000DecodedMsg):
    ...
    def decode_payload(self, payload, start_byte=0):
        val = self._struct_str_0.unpack_from(payload, 0 + start_byte)
        self._system_id = val[0]
        self._speed_through_water = check_convert_float(val[1], 0xffff, 0.01)
        self._speed_over_ground_ref = check_convert_float(val[2], 0xffff, 0.01)
...
class Pgn128267Class(NMEA2000DecodedMsg):
    ...
    def decode_payload(self, payload, start_byte=0):
        ...
        self._offset = check_convert_float(val[2], 0xffff, 0.001)
...
class Pgn129025Class(NMEA2000DecodedMsg):
    ...
    def decode_payload(self, payload, start_byte=0):
        val = self._struct_str_0.unpack_from(payload, 0 + start_byte)
        self._latitude = check_convert_float(val[0], 0xffffffff, 1e-07)
        self._longitude = check_convert_float(val[1], 0xffffffff, 1e-07)
...
class Pgn129029Class(NMEA2000DecodedMsg):
    ...
    class Ref_StationsClass:
        ...
        def decode_payload(self, payload, start_byte=0):
            ...
            self._age_DGNSS_correction = check_convert_float(val[1], 0xffff, 0.01)
    ...
    def decode_payload(self, payload, start_byte=0):
        ...
        self._latitude = check_convert_float(val[3], 0xffffffffffffffff, 1e-16)
        self._longitude = check_convert_float(val[4], 0xffffffffffffffff, 1e-16)
        self._altitude = check_convert_float(val[5], 0xffffffffffffffff, 1e-06)
        self._method = val[6] & 0xF
        self._GNSS_type = (val[6] >> 4) & 0xF
        self._integrity = val[7] & 0x3
        self._number_of_sv = val[8]
        self._HDOP = check_convert_float(val[9], 0xffff, 0.01)
        self._PDOP = check_convert_float(val[10], 0xffff, 0.01)
        self._geoidal_separation = check_convert_float(val[11], 0xffffffff, 0.01)
...
class Pgn129039Class(NMEA2000DecodedMsg):
    ...
    def decode_payload(self, payload, start_byte=0):
        ...
        self._mmsi = val[1]
        self._longitude = check_convert_float(val[2], 0xffffffff, 1e-07)
        self._latitude = check_convert_float(val[3], 0xffffffff, 1e-07)
...
class Pgn129540Class(NMEA2000DecodedMsg):
    ...
    class Satellites_DataClass:
        ...
        def decode_payload(self, payload, start_byte=0):
            ...
            self._elevation = check_convert_float(val[1], 0xffff, 0.005729577951308233)
...
class Pgn130306Class(NMEA2000DecodedMsg):
    ...
    def decode_payload(self, payload, start_byte=0):
        val = self._struct_str_0.unpack_from(payload, 0 + start_byte)
        self._system_id = val[0]
        self._wind_speed = check_convert_float(val[1], 0xffff, 0.01)
...
class Pgn130310Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0 = struct.Struct('<BhhHB')
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_system_id', '_water_temperature', '_outside_air_temperature', '_atmospheric_temperature')
    ...
    @property
    def atmospheric_temperature(self) -> int:
    ...
    def decode_payload(self, payload, start_byte=0):
        ...
        self._atmospheric_temperature = val[3]
    ...
    def encode_payload(self) -> bytearray:
        ...
        v2 = 0xff
        self._struct_str_0.pack_into(buffer, 0 + start_byte, self._system_id, v0, v1, self._atmospheric_temperature, v2)
        return buffer
    ...
    def from_protobuf(self, message: Pgn130310ClassPb):
        ...
        self._atmospheric_temperature = message.atmospheric_temperature
    ...
    def as_protobuf(self) -> Pgn130310ClassPb:
        ...
        message.atmospheric_temperature = self._atmospheric_temperature
        return message
    ...
    def __str__(self):
        return f'PGN{self._pgn}({self._name}) [system_id={self._system_id}, water_temperature={self._water_temperature}, outside_air_temperature={self._outside_air_temperature}, atmospheric_temperature={self._atmospheric_temperature}]'
...
class Pgn130311Class(NMEA2000DecodedMsg):
    ...
    def decode_payload(self, payload, start_byte=0):
        ...
        self._humidity = check_convert_float(val[3], 0xffff, 0.004)
        self._atmospheric_pressure = val[4]
    ...
    def encode_payload(self) -> bytearray:
        ...
        self._struct_str_0.pack_into(buffer, 0 + start_byte, self._system_id, v0, v1, v2, self._atmospheric_pressure)
        return buffer
...
class Pgn130578Class(NMEA2000DecodedMsg):
    ...
    def decode_payload(self, payload, start_byte=0):
        val = self._struct_str_0.unpack_from(payload, 0 + start_byte)
        self._longitudinal_speed_water = check_convert_float(val[0], 0xffff, 0.001)
        self._transverse_speed_water = check_convert_float(val[1], 0xffff, 0.001)
        self._longitudinal_speed_ground = check_convert_float(val[2], 0xffff, 0.001)
        self._transverse_speed_ground = check_convert_float(val[3], 0xffff, 0.001)
        self._stern_speed_water = check_convert_float(val[4], 0xffff, 0.001)
        self._stern_speed_ground = check_convert_float(val[5], 0xffff, 0.001)
...
class Pgn130842Mfg1857Class(NMEA2000DecodedMsg):
    ...
    _pgn = 130842
    _name = 'Simnet: AIS Class B static data (msg 24 Part A)'
    _proprietary = True
    _manufacturer_id = 1857
    _struct_str_0 = struct.Struct('<HBBBi')
    _struct_str_0_size = _struct_str_0.size
    ...
    def decode_payload(self, payload, start_byte=0):
        ...
        self._mmsi = val[4]
        self._ship_name = clean_string(payload[9 + start_byte: 29 + start_byte])
