...
class Pgn65379Mfg1851Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        start_byte = 0
        v0 = 0x7ff << 0
        self._struct_str_0.pack_into(buffer, 0 + start_byte, v0, self._system_id, self._pilot_mode, self._sub_mode, self._pilot_mode_data)
        return buffer
...
class Pgn128259Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        v1 = convert_to_int(self._speed_over_ground_ref, 0x7fff, 0.01)
        v2 = 0xffff
...
class Pgn128267Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        v2 = convert_to_int(self._range, 0x7f, 10.0)
...
class Pgn129029Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        self._struct_str_0.pack_into(buffer, start_byte, self._system_id, self._date, v0, v1, v2, v3, v4, v5, self._number_of_sv, v6, v7, v8, self._nb_ref_stations)
        start_byte += 43
...
class Pgn129540Class(NMEA2000DecodedMsg):
    ...
    class Satellites_DataClass:
        ...
        def encode_payload(self, buffer, start_byte):
            ...
            v1 = convert_to_int(self._azimuth, 0x7fff, 0.005729577951308233)
            v2 = convert_to_int(self._signal_noise_ratio, 0x7fff, 0.01)
    ...
    def encode_payload(self) -> bytearray:
        ...
        v0 = (self._mode & 0x3) << 0
        v0 |= 0x3f << 2
        self._struct_str_0.pack_into(buffer, start_byte, self._system_id, v0, self._sats_in_view)
        start_byte += 3
...
class Pgn129794Class(NMEA2000DecodedMsg):
    ...
    def encode_payload(self) -> bytearray:
        ...
        v3 = convert_to_int(self._position_from_bow, 0x7fff, 0.1)
