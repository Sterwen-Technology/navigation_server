...
class Pgn129285Class(NMEA2000DecodedMsg):
    ...
    _struct_str_1_size = _struct_str_1.size
    __slots__ = ('_start_rps_nb', '_nb_items', '_database_id', '_route_id', '_navigation_direction', '_supplementary_data', '_route_name', '_WP_definitions')
    ...
    def __str__(self):
        return f'PGN{self._pgn}({self._name}) [start_rps_nb={self._start_rps_nb}, nb_items={self._nb_items}, database_id={self._database_id}, route_id={self._route_id}, navigation_direction={self._navigation_direction}, supplementary_data={self._supplementary_data}, route_name={self._route_name}, WP_definitions={self._WP_definitions}]'
