...
class NMEAServer(object):
    ...
    def status(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/NMEAServer/status',
    ...
    def sendNMEA(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/NMEAServer/sendNMEA',
    ...
    def getNMEA(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/NMEAServer/getNMEA',
            nmea__messages__pb2.server_cmd.SerializeToString,
