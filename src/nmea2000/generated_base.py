...
from router_common import MessageServerGlobals, get_global_enum, N2KDecodeException
...
class NMEA2000DecodedMsg:
    ...
    canboat_header = '{{"timestamp:":"{0}","prio":{1},"src":{2},"dst":{3},"pgn":{4},"description":"{5}", "fields":{{'
