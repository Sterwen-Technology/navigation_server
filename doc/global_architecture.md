...
- AgentService [agent.proto](../protobuf/agent.proto)
- NetworkService [network.proto](../protobuf/network.proto)
...
supported gRPC services:
- N2KCanService [n2k_can_service.proto](../protobuf/n2k_can_service.proto)
...
supported gRPC services:
- Console [console.proto](../protobuf/console.proto)
...
supported gRPC services:
- GNSSService [gnss.proto](../protobuf/gnss.proto)
...
supported gRPC services:
- MPPTService [energy.proto](../protobuf/energy.proto)
...
- EngineDataService [engine_data.proto](../protobuf/engine_data.proto)
