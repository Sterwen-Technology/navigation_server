...
The agent local server allows remotely controlling all processes involved in the navigation server system. It can also perform basic functions on the underlying Linux system like halting or rebooting it.
