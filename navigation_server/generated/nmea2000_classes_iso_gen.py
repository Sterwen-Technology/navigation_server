...
class Pgn126993Class(NMEA2000DecodedMsg):
    ...
    __slots__ = ('_interval', '_sequence', '_ctrl1_state', '_ctrl2_state', '_equipment_status') + NMEA2000DecodedMsg.__slots__
...
class Pgn126996Class(NMEA2000DecodedMsg):
    ...
    __slots__ = ('_nmea2000_version', '_product_code', '_model_id', '_software_version', '_model_version', '_model_serial_code', '_certification_level', '_load_equivalency') + NMEA2000DecodedMsg.__slots__
...
class Pgn126998Class(NMEA2000DecodedMsg):
    ...
    __slots__ = ('_installation_1', '_installation_2', '_manufacturer_info') + NMEA2000DecodedMsg.__slots__
