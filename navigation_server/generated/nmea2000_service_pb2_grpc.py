...
import navigation_server.generated.nmea2000_service_pb2 as nmea2000__service__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in nmea2000_service_pb2_grpc.py depends on'
...
class Nmea2000ControllerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StopTrace = channel.unary_unary(
                '/Nmea2000ControllerService/StopTrace',
                request_serializer=nmea2000__service__pb2.Nmea2000Request.SerializeToString,
                response_deserializer=nmea2000__service__pb2.Nmea2000ControllerMsg.FromString,
                _registered_method=True)
        self.ReadNmea2000Msg = channel.unary_stream(
                '/Nmea2000ControllerService/ReadNmea2000Msg',
                request_serializer=nmea2000__service__pb2.Nmea2000ReadRequest.SerializeToString,
                response_deserializer=nmea2000__pb2.nmea2000pb.FromString,
                _registered_method=True)
        self.SendNmea2000Msg = channel.unary_unary(
                '/Nmea2000ControllerService/SendNmea2000Msg',
                request_serializer=nmea2000__service__pb2.Nmea2000SendRequest.SerializeToString,
                response_deserializer=nmea2000__service__pb2.Nmea2000Ack.FromString,
                _registered_method=True)
        self.SendNmea2000Stream = channel.stream_unary(
                '/Nmea2000ControllerService/SendNmea2000Stream',
...
class Nmea2000ControllerServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_Nmea2000ControllerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReadNmea2000Msg': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=nmea2000__service__pb2.Nmea2000ReadRequest.FromString,
            ...
            'SendNmea2000Msg': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=nmea2000__service__pb2.Nmea2000SendRequest.FromString,
                    response_serializer=nmea2000__service__pb2.Nmea2000Ack.SerializeToString,
            ),
            'SendNmea2000Stream': grpc.stream_unary_rpc_method_handler(
                    servicer.SendNmea2000Stream,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'Nmea2000ControllerService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('Nmea2000ControllerService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class Nmea2000ControllerService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def ReadNmea2000Msg(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/Nmea2000ControllerService/ReadNmea2000Msg',
            nmea2000__service__pb2.Nmea2000ReadRequest.SerializeToString,
    ...
    def SendNmea2000Msg(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Nmea2000ControllerService/SendNmea2000Msg',
            nmea2000__service__pb2.Nmea2000SendRequest.SerializeToString,
            nmea2000__service__pb2.Nmea2000Ack.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def SendNmea2000Stream(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
