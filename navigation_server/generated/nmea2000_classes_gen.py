#   Python code generated by NMEA message router application (c) Sterwen Technology 2026
#   generated on 2026-08-31:18:47
#   do not modify code
...
class Pgn65359Mfg1851Class(NMEA2000DecodedMsg):
    ...
    __slots__ = ('_sequence_id', '_true_heading', '_magnetic_heading') + NMEA2000DecodedMsg.__slots__
...
class Pgn65379Mfg1851Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_pilot_mode', '_sub_mode', '_pilot_mode_data') + NMEA2000DecodedMsg.__slots__
...
class Pgn126992Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_source', '_date', '_time') + NMEA2000DecodedMsg.__slots__
...
class Pgn127245Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_instance', '_direction', '_angle', '_position') + NMEA2000DecodedMsg.__slots__
...
class Pgn127250Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_heading', '_deviation', '_variation', '_reference') + NMEA2000DecodedMsg.__slots__
...
class Pgn127258Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_source', '_age_of_service', '_variation') + NMEA2000DecodedMsg.__slots__
...
class Pgn127488Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_engine_instance', '_engine_speed') + NMEA2000DecodedMsg.__slots__
...
class Pgn127489Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_engine_instance', '_oil_pressure', '_oil_temperature', '_temperature', '_alternator_voltage', '_fuel_rate', '_total_engine_hours') + NMEA2000DecodedMsg.__slots__
...
class Pgn127506Class(NMEA2000DecodedMsg):

    _pgn = 127506
    _name = 'DC Detailed Status'
    _proprietary = False

    @staticmethod
    def protobuf_class():
        return Pgn127506ClassPb

    _struct_str_0 = struct.Struct('<BBBBBHhH')
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_instance', '_DC_type', '_SoC', '_SoH', '_time_remaining', '_ripple_voltage', '_remaining_capacity') + NMEA2000DecodedMsg.__slots__
    ...
    _json_format = (
        GenericFormatter('_sequence_id', 'SID', 0xff),
        GenericFormatter('_instance', 'DC Instance', 0xff),
        EnumFormatter('_DC_type', 'DC Type', 0xff, local = _DC_type_enum ),
        GenericFormatter('_SoC', 'State of Charge', 0xff),
        GenericFormatter('_SoH', 'State of Health', 0xff),
        GenericFormatter('_time_remaining', 'Time Remaining', 0xffff),
        FloatFormatter('_ripple_voltage', 'Ripple Voltage', '{:.2f}'),
        GenericFormatter('_remaining_capacity', 'Remaining capacity', 0xffff)
        )
    ...
    @property
    def ripple_voltage(self) -> float:
        return self._ripple_voltage
    ...
    @DC_type.setter
    def DC_type(self, value: int):
        self._DC_type = value

    @SoC.setter
    def SoC(self, value: int):
        self._SoC = value

    @SoH.setter
    def SoH(self, value: int):
        self._SoH = value
    ...
    @ripple_voltage.setter
    def ripple_voltage(self, value: float):
        self._ripple_voltage = value

    @remaining_capacity.setter
    def remaining_capacity(self, value: int):
        self._remaining_capacity = value

    @property
    def DC_type_text(self) -> str:
        return self._DC_type_enum.get(self._DC_type, 'DC_type key error')

    def decode_payload(self, payload, start_byte=0):
        val = self._struct_str_0.unpack_from(payload, start_byte)
        self._sequence_id = val[0]
        self._instance = val[1]
        self._DC_type = val[2]
        self._SoC = val[3]
        self._SoH = val[4]
        self._time_remaining = val[5]
        self._ripple_voltage = check_convert_float(val[6], 0x7fff, 0.01)
        self._remaining_capacity = val[7]
        start_byte += 11
        return self
    ...
    def encode_payload(self) -> bytearray:
        ...
        buffer = bytearray(buf_size)
        start_byte = 0
        v0 = convert_to_int(self._ripple_voltage, 0x7fff, 0.01)
        self._struct_str_0.pack_into(buffer, 0 + start_byte, self._sequence_id, self._instance, self._DC_type, self._SoC, self._SoH, self._time_remaining, v0, self._remaining_capacity)
        return buffer

    def from_protobuf(self, message: Pgn127506ClassPb):
        self._sequence_id = message.sequence_id
        self._instance = message.instance
        self._DC_type = message.DC_type
        self._SoC = message.SoC
        self._SoH = message.SoH
        self._time_remaining = message.time_remaining
        self._ripple_voltage = message.ripple_voltage
        self._remaining_capacity = message.remaining_capacity

    def as_protobuf(self) -> Pgn127506ClassPb:
        message = Pgn127506ClassPb()
        message.sequence_id = self._sequence_id
        message.instance = self._instance
        message.DC_type = self._DC_type
        message.SoC = self._SoC
        message.SoH = self._SoH
        message.time_remaining = self._time_remaining
        message.ripple_voltage = self._ripple_voltage
        message.remaining_capacity = self._remaining_capacity
        return message

    def set_protobuf(self, message: Pgn127506ClassPb):
        message.sequence_id = self._sequence_id
        message.instance = self._instance
        message.DC_type = self._DC_type
        message.SoC = self._SoC
    ...
    def unpack_protobuf(self, protobuf: nmea2000_decoded_pb):
        payload = Pgn127506ClassPb()
        protobuf.payload.Unpack(payload)
        self.from_protobuf(payload)

    def __str__(self):
        return f'PGN{self._pgn}({self._name}) [sequence_id={self._sequence_id}, instance={self._instance}, DC_type={self._DC_type}, SoC={self._SoC}, SoH={self._SoH}, time_remaining={self._time_remaining}, ripple_voltage={self._ripple_voltage}, remaining_capacity={self._remaining_capacity}]'
...
class Pgn127507Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0 = struct.Struct('<BBBBH')
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_charger_instance', '_battery_instance', '_operating_state', '_charger_mode', '_charger_enable', '_equalization_pending', '_eq_time_remaining') + NMEA2000DecodedMsg.__slots__
    ...
    _json_format = (
        ...
        GenericFormatter('_operating_state', 'Operating State', 0xf),
        GenericFormatter('_charger_mode', 'Charge Mode', 0xf),
    ...
    def decode_payload(self, payload, start_byte=0):
        ...
        self._operating_state = val[2] & 0xF
        self._charger_mode = (val[2] >> 4) & 0xF
        self._charger_enable = val[3] & 0x3
        self._equalization_pending = (val[3] >> 2) & 0x3
        self._eq_time_remaining = val[4]
        start_byte += 6
        return self
    ...
    def encode_payload(self) -> bytearray:
        ...
        buffer = bytearray(buf_size)
        start_byte = 0
        v0 = (self._operating_state & 0xf) << 0
        v0 |= (self._charger_mode & 0xf) << 4
        v1 = (self._charger_enable & 0x3) << 0
        v1 |= (self._equalization_pending & 0x3) << 2
        v1 |= 0xf << 4
        self._struct_str_0.pack_into(buffer, 0 + start_byte, self._charger_instance, self._battery_instance, v0, v1, self._eq_time_remaining)
        return buffer
...
class Pgn127508Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0 = struct.Struct('<BhhHB')
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_battery_instance', '_voltage', '_current', '_temperature', '_sequence_id') + NMEA2000DecodedMsg.__slots__
...
class Pgn127751Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_connection_number', '_voltage', '_current') + NMEA2000DecodedMsg.__slots__
...
class Pgn128259Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0 = struct.Struct('<BhhBH')
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_speed_through_water', '_speed_over_ground', '_speed_through_water_reference') + NMEA2000DecodedMsg.__slots__
...
class Pgn128267Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_depth', '_offset', '_range') + NMEA2000DecodedMsg.__slots__
...
class Pgn128275Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_date', '_time', '_total_log', '_trip_log') + NMEA2000DecodedMsg.__slots__
...
class Pgn129025Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_latitude', '_longitude') + NMEA2000DecodedMsg.__slots__
...
class Pgn129026Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0 = struct.Struct('<BBHHH')
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_COG_reference', '_COG', '_SOG') + NMEA2000DecodedMsg.__slots__
...
class Pgn129029Class(NMEA2000DecodedMsg):
    ...
    class Ref_StationsClass:
        ...
        _struct_str_0_size = _struct_str_0.size
        __slots__ = ('_GNSS_type', '_station_id', '_age_DGNSS_correction') + NMEA2000DecodedMsg.__slots__
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_date', '_time', '_latitude', '_longitude', '_altitude', '_GNSS_type', '_method', '_integrity', '_number_of_sv', '_HDOP', '_PDOP', '_geoidal_separation', '_nb_ref_stations', '_ref_stations') + NMEA2000DecodedMsg.__slots__
...
class Pgn129038Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_message_id', '_repeat_indicator', '_mmsi', '_longitude', '_latitude', '_position_accuracy', '_RAIM', '_report_timestamp', '_COG', '_SOG', '_communication_state', '_transceiver_information', '_heading', '_rate_of_turn', '_navigation_status') + NMEA2000DecodedMsg.__slots__
...
class Pgn129039Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_message_id', '_repeat_indicator', '_mmsi', '_longitude', '_latitude', '_position_accuracy', '_RAIM', '_report_timestamp', '_COG', '_SOG', '_communication_state', '_transceiver_info', '_heading', '_unit_type', '_band', '_handle_msg22', '_AIS_mode', '_AIS_communication_state') + NMEA2000DecodedMsg.__slots__
...
class Pgn129283Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_XTE_mode', '_navigation_terminated', '_XTE') + NMEA2000DecodedMsg.__slots__
...
class Pgn129285Class(NMEA2000DecodedMsg):
    ...
    class Wp_DefinitionsClass:
        ...
        __slots__ = ('_waypoint_id', '_waypoint_name', '_waypoint_latitude', '_waypoint_longitude') + NMEA2000DecodedMsg.__slots__
    ...
    _struct_str_1_size = _struct_str_1.size
    __slots__ = ('_start_waypoint_id', '_nb_items', '_database_id', '_route_id', '_navigation_direction', '_supplementary_data', '_route_name', '_WP_definitions') + NMEA2000DecodedMsg.__slots__
...
class Pgn129539Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0 = struct.Struct('<BBhhh')
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_desired_mode', '_actual_mode', '_HDOP', '_VDOP', '_TDOP') + NMEA2000DecodedMsg.__slots__
...
class Pgn129540Class(NMEA2000DecodedMsg):
    ...
    class Satellites_DataClass:
        ...
        _struct_str_0_size = _struct_str_0.size
        __slots__ = ('_satellite_number', '_elevation', '_azimuth', '_signal_noise_ratio', '_range_residuals', '_status') + NMEA2000DecodedMsg.__slots__
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_mode', '_sats_in_view', '_satellites_data') + NMEA2000DecodedMsg.__slots__
...
class Pgn129794Class(NMEA2000DecodedMsg):
    ...
    __slots__ = ('_message_id', '_repeat_indicator', '_mmsi', '_IMO_number', '_callsign', '_ship_name', '_type_of_ship', '_length', '_beam', '_position_from_starboard', '_position_from_bow', '_ETA_date', '_ETA_time', '_draft', '_destination', '_AIS_version', '_GNSS_type', '_DTE', '_AIS_transceiver_info') + NMEA2000DecodedMsg.__slots__
...
class Pgn129809Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_message_id', '_repeat_indicator', '_mmsi', '_ship_name') + NMEA2000DecodedMsg.__slots__
...
class Pgn129810Class(NMEA2000DecodedMsg):
    ...
    _struct_str_1_size = _struct_str_1.size
    __slots__ = ('_message_id', '_repeat_indicator', '_mmsi', '_type_of_ship', '_vendor_id', '_call_sign', '_length', '_beam', '_position_from_starboard', '_position_from_bow', '_mothership_mmsi') + NMEA2000DecodedMsg.__slots__
...
class Pgn130074Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_start_wp_id', '_nb_items', '_nb_valid_wp', '_database_id', '_WP_definitions') + NMEA2000DecodedMsg.__slots__
...
class Pgn130306Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0 = struct.Struct('<BhHHB')
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_wind_speed', '_wind_angle', '_reference') + NMEA2000DecodedMsg.__slots__
...
class Pgn130310Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0 = struct.Struct('<BHHHB')
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_water_temperature', '_outside_air_temperature', '_atmospheric_pressure') + NMEA2000DecodedMsg.__slots__
...
class Pgn130311Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0 = struct.Struct('<BBHhH')
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_temperature_instance', '_humidity_instance', '_temperature', '_humidity', '_atmospheric_pressure') + NMEA2000DecodedMsg.__slots__
...
class Pgn130312Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_temperature_instance', '_temperature_source', '_actual_temperature', '_set_temperature') + NMEA2000DecodedMsg.__slots__
...
class Pgn130314Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_sequence_id', '_pressure_instance', '_pressure_source', '_pressure') + NMEA2000DecodedMsg.__slots__
...
class Pgn130578Class(NMEA2000DecodedMsg):
    ...
    _struct_str_0_size = _struct_str_0.size
    __slots__ = ('_longitudinal_speed_water', '_transverse_speed_water', '_longitudinal_speed_ground', '_transverse_speed_ground', '_stern_speed_water', '_stern_speed_ground') + NMEA2000DecodedMsg.__slots__
...
class Pgn130842Mfg1857Class(NMEA2000DecodedMsg):
    ...
    _struct_str_1_size = _struct_str_1.size
    __slots__ = ('_message_id', '_repeat_indicator', '_mmsi', '_type_of_ship', '_vendor_id', '_call_sign', '_length', '_beam', '_position_from_starboard') + NMEA2000DecodedMsg.__slots__
