...
class NetworkClient(ServiceClient):
    ...
    def set_global_configuration(self, command:str):
        ...
        request = NetworkCommand()
        request.cmd = command
        return self._server_call(self._stub.set_global_configuration, request, NetworkReplyProxy)

    def set_configuration(self, command:str, interface:str, connection:str):
        _logger.debug("Call set_configuration")
        request = NetworkCommand()
        request.cmd = command
        request.interface = interface
        request.connection = connection
        return self._server_call(self._stub.set_configuration, request, NetworkStatusProxy)
