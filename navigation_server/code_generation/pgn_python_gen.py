...
from navigation_server.router_common import Typedef, N2KDecodeException
...
class PythonPGNGenerator:
    ...
    def __init__(self, output_file: str, read_only: bool):
        ...
        self._level = 0
        self.write('#   Python code generated by NMEA message router application (c) Sterwen Technology 2026\n')
    ...
    def gen_classes(self, class_def_list: list, protobuf_conv: bool, base_name: str):
        # add protobuf import
        if protobuf_conv:
            self._of.write(f"from navigation_server.generated.{base_name}_pb2 import *\n\n")
    ...
    def gen_class_variables(self, pgn_def: FieldSetMeta, attributes, last_attr):
        ...
        # change is version 2.7.1 2026-02-13 add base class slots
        self.write("__slots__ = (")
        for attr in attributes[:last_attr]:
            self._of.write("'%s', " % attr.variable)
        self._of.write("'%s')" % attributes[last_attr].variable)
        # added on 2026-02-13 LCA
        self._of.write(f" + {self.message_base_class}.__slots__\n\n")
